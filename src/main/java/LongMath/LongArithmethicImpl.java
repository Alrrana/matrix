...
import MatrixModules.Numeric;
import org.junit.platform.commons.util.StringUtils;

public class LongArithmethicImpl implements LongArithmethic {
    ...
    public LongArithmethicImpl(String number) {
